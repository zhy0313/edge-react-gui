...
import type { AbcCurrencyWallet, AbcDenomination, AbcMetaToken, EdgeReceiveAddress } from 'edge-core-js'
...
function schema (wallet: AbcCurrencyWallet, receiveAddress: EdgeReceiveAddress): GuiWallet {
